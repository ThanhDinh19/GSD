        ...
        detailGroups.map(
            (
                        ...
                        .map(
                            (
                                ...
                                return {
                                    /*
                                     * Quan trọng:
                                     * giữ operation.id thật trong DB.
                                     * Backend dùng id này để biết đây là dòng cũ.
                                     */
                                    id:
                                        operation.id ??
                                        null,
                ...
                return {
                    /*
                     * Quan trọng:
                     * giữ group.id thật trong DB.
                     * Backend dùng id này để biết đây là group cũ.
                     */
                    id:
                        group.id ??
                        null,
