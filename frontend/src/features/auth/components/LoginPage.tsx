...
export function LoginPage() {
  ...
  const [grassrootsLevelUnit, setGrassRootLevelUnit] = useState<GrassrootsLevelUnit[]>([]);
  ...
  useEffect(() => {
    const getGrassRootsLevelUnit = async () => {
      ...
      try {
        ...
        setGrassRootLevelUnit(data.data);
      } catch (error) {
        console.error(error)
      }
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {grassrootsLevelUnit.map((unit) => (
                      <option
                        key={unit.id}
                        value={unit.department_code}
                      >
