...
export default function OperationClusterPage() {
    ...
    type PageTab = 'form' | 'saved';

    const [activePageTab, setActivePageTab] = useState<PageTab>('form');
            ...
            prev.map((group, groupIndex) => {
                ...
                const newOperations: OperationClusterOperationPayload[] = selectedGsds.map(
                    (gsd, index) => ({
                        ...
                        skill_grade_id: gsd.skill_grade_id,
                        ...
                        salary_coefficient: toNumber(gsd.salary_coefficient, 0),
                        manpower: 1,
        ...
        <div className="h-full min-h-0 bg-slate-50 p-4 overflow-auto">
                ...
                {activePageTab === 'form' && (
                    <>
                        ...
                        <div className="grid grid-cols-[1.15fr_0.85fr] gap-4">
                            ...
                            <div className="bg-white border border-slate-200 rounded-sm shadow-sm p-5">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div
                                        className={`px-3 py-1 rounded-full text-xs ${form.status_id === 0
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full border border-slate-300 rounded-sm px-3 py-2 text-sm outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 bg-yellow-50"
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full border border-slate-300 rounded-sm px-3 py-2 text-sm bg-white outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100"
                                        >
                                            <option value="">
                                                {worksLoading ? 'Đang tải...' : '-- Chọn nhóm công việc --'}
                                            </option>
                                    ...
                                    <div>
                                        ...
                                        >
                                            <option value="">
                                                {productCatesLoading ? 'Đang tải...' : '-- Chọn chủng loại --'}
                                            </option>
                                    ...
                                    <div>
                                        ...
                                        >
                                            <option value="">
                                                {productCateGroupsLoading ? 'Đang tải...' : '-- Chọn nhóm chủng loại --'}
                                            </option>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full border border-slate-300 rounded-sm px-3 py-2 text-sm outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 text-right"
                                            placeholder="VD: 0.8"
                                        />

                                        <div className="text-[11px] text-slate-400 mt-1">
                                            Nhập dạng hệ số: 80% = 0.8, 100% = 1
                                        </div>
                                    </div>
                                </div>

                                <div className="mt-5 border-t border-slate-100 pt-4 flex flex-wrap items-center gap-4">
                                ...
                                <div className="mt-4">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full border border-slate-300 rounded-sm px-3 py-2 text-sm outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100"
                                        rows={2}
                            ...
                            <div className="bg-white border border-slate-200 rounded-sm shadow-sm p-5">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="rounded-sm border border-blue-100 bg-blue-50 p-4">
                                        ...
                                        <div className="text-2xl  text-blue-700 mt-1">
                                    ...
                                    <div className="rounded-sm border border-emerald-100 bg-emerald-50 p-4">
                                        ...
                                        <div className="text-2xl text-emerald-700 mt-1">
                                    ...
                                    <div className="rounded-sm border border-amber-100 bg-amber-50 p-4">
                                        <div className="text-xs font-bold text-amber-500 uppercase">
                                            Tổng giây GSD
                                        </div>
                                        <div className="text-2xl text-amber-700 mt-1">
                                            {dashboard.totalActionSeconds.toFixed(2)}
                                        </div>
                                    </div>

                                    <div className="rounded-sm border border-violet-100 bg-violet-50 p-4">
                                        <div className="text-xs font-bold text-violet-500 uppercase">
                                            Định mức lao động
                                        </div>
                                        <div className="text-2xl text-violet-700 mt-1">
                                    ...
                                    <div className="rounded-sm border border-slate-200 bg-slate-50 p-4">
                                        ...
                                        <div className="text-2xl text-slate-700 mt-1">
                        ...
                        <div className="grid grid-cols-[360px_1fr] gap-4">
                            ...
                            {/* Công đoạn */}
                            <div className="bg-white border border-slate-200 rounded-sm shadow-sm p-4 min-h-[620px] flex flex-col min-w-0">
            ...
            {isSavedDetailOpen && selectedDetail && (
                <div className="fixed inset-0 z-50 bg-slate-900/40 flex items-center justify-center p-6">
                    <div className="w-[1280px] max-w-[96vw] max-h-[90vh] bg-white rounded-lg shadow-2xl flex flex-col overflow-hidden">
                        ...
                        <div className="p-5 space-y-4 overflow-auto">
                            ...
                            {/* <div className="border border-slate-200 rounded-sm overflow-hidden">
                                ...
                                <table className="w-full text-sm">
                                    <thead className="bg-white">
                                        <tr className="text-xs text-slate-500 uppercase">
                                            <th className="p-3 border-b border-slate-200 text-left w-[80px]">
                                                STT
                                            </th>
                                            <th className="p-3 border-b border-slate-200 text-left">
                                                Tên cụm
                                    ...
                                    <tbody>
                                        ...
                                        {(selectedDetail.groups || []).map((group: any, index: number) => (
                                            <tr key={group.id || index} className="border-b border-slate-100">
                                                <td className="p-3 text-slate-500">
                                                        ...
                                                        <tbody>
                                                            {actions.map((action) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <td className="p-2 font-semibold text-blue-700 truncate">
                                                                        {action.gsd_code || '-'}
                                                                    </td>
